...
app.get("/", (request, response) => {
  let datnow = new Date()
  console.log(datnow.toTimeString() + "  pang");
...
client.on('message', async (message) => {
  ...
  if (command === '') {
    ...
    message.channel.send({
      files: [{
        attachment: 'https://cdn.glitch.com/829c23ab-c857-4d3b-967a-7c458cff4bd3%2Flucky.jpg?1525807488131',
        name: 'lucky.jpg'
      }]
    })
  } // 'a real command'
...
`
    ...
    message.channel.send({
      files: [{
        attachment: 'https://cdn.glitch.com/829c23ab-c857-4d3b-967a-7c458cff4bd3%2Frainbow-barf.gif?1525807486570',
    ...
    message.channel.send({
      files: [{
        attachment: 'https://cdn.glitch.com/829c23ab-c857-4d3b-967a-7c458cff4bd3%2Fgnightmare.gif?1525807484558',
        name: 'gnightmare.gif'
      }]
    })
  } // gnome
    ...
    if (emoj) {
      ...
      message.channel.send({
        files: [{
          attachment: 'https://cdn.glitch.com/829c23ab-c857-4d3b-967a-7c458cff4bd3%2Fgnome.png?1525807483798',
          name: 'gnome.png'
        }]
      })
    }
    ...
    if (emoj) {
      ...
      message.channel.send({
        files: [{
          attachment: 'https://cdn.glitch.com/829c23ab-c857-4d3b-967a-7c458cff4bd3%2FAAAAAAAAAA.png?1525807483899',
          name: 'AAAAAAAAAA.png'
        }]
      })
    }
...
\`\`\`
    ...
    message.channel.send({
      files: [{
        attachment: 'https://cdn.glitch.com/829c23ab-c857-4d3b-967a-7c458cff4bd3%2Fc7d62c.png?1525807483207',
        name: 'c7d62c.png'
      }]
    })
  } // snot lore
